...
/*
 * Changing threshold to 5ns for DWM3000 B0 red board devices.
 ...
 * This should be fixed for DWM3000 C0 devices.
 */
#define TS_MISMATCH_THRESHOLD 5*64       /* 64 = 1 ns --> 5 ns */

/*
 * Please note that a PRF of 16 MHz and a STS PRF of 64 MHz will not be supported for the DWM3000.
 */
