/*! ----------------------------------------------------------------------------
 * @file    deca_version.h
 * @brief   Defines the version info for the DWM3000 device driver including its API
 *
 * @attention
 *
...
//
// The DWM3000 device driver is separately version numbered to any version the application using it may have
//
...
#define DWM3000_DRIVER_VERSION               0x040000
#define DWM3000_DEVICE_DRIVER_VER_STRING     "DWM3000 C0 Device Driver Version 04.00.00"
